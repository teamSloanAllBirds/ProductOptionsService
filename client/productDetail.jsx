      ...
      <div>
        ...
        <div id="highlight-block">
          <div style={{display: "inline-block", width: "30%", verticalAlign: "top", fontSize: "x-small", padding: "5px", margin: "auto"}}>
            <img src="https://cdn.allbirds.com/image/fetch/q_auto,f_auto/f_auto,q_auto/https://images.ctfassets.net/9uo1qvvet3xa/5RRq6D7d2XTZqvdmMIZQao/8499977205e7511610408842c3e2e925/4pdp-attributes-dasher-sprinter.png" height="44px" width="44px" marginLeft="auto" marginRight="auto"></img><br></br>
